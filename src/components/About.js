  ...
  return(
    <div style={{display:'flex',justifyContent:'center',backgroundColor:'#03A9F4', height:'100%', width:'100vw',maxWidth:'100%',margin:0, padding:0,fontFamily:'Segoe UI'}}>
        <div style={{display:'flex',flexDirection:'column',height:'100vh'}}>
              <h1 className="tracking-in-expand" style={{ fontFamily:'Segoe UI', fontSize:'30px',fontSize:'3.5vw', color:'#fff',alignSelf:'center'}}>Hello! I'm Mackenzie,</h1>


        <div style={{ alignItems:'flex-start',marginBottom:'200px',}}>
            <Titles />
        </div>
